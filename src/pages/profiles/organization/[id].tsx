...
import Test from "@/assets/logovo.png";
import Test1 from "@/assets/testOrg.png";
          ...
          <div className="rounded-lg border sm:col-span-3">
            <div className="h-full bg-white px-6">
              <div className="flex flex-col items-center justify-center pt-12">
                ...
                />
                <p className=" text-2xl font-semibold">LOGOVO</p>
                <p className=" text-sm">Cоздание виртуальных туров</p>
              ...
              <div className="grid grid-cols-2 gap-y-4">
                ...
                <div>
                  <p className=" text-sm text-slate-400">Отрасль</p>
                  <p className="text-sm">Создание виртуальных туров</p>
                </div>
                <div>
              ...
              <div className="">
                ...
                <p className="pt-3  text-sm">
                  Компания LOGOVO занимается созданием виртуальных туров для
                  компаний города Астана
                </p>
              </div>
              ...
              <Tabs defaultValue="job">
                <TabsList className="flex justify-around border border-slate-100 bg-white p-9 text-lg font-semibold text-slate-300">
                  <div className="flex flex-row flex-nowrap gap-10 overflow-x-auto md:w-full md:justify-around">
                    ...
                    <TabsTrigger value="sertification">Сертификаты</TabsTrigger>
                    <TabsTrigger value="materials">Доп. материалы</TabsTrigger>
                      ...
                      <div className="sm:col-span-8">
                        <div>
                          ...
                          <p className="text-sm font-normal">
                            Виртуальный тур по всем филиалам компании
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <div className="">
                          ...
                          <p className="rounded-b-lg bg-slate-100 py-3 px-4">
                      ...
                      <p className="mt-12 mb-3 text-xl font-semibold text-slate-400">
                        Видео
                      </p>
                      <div className="grid gap-4  sm:grid-cols-2">
                        <div className="">
                          <Image src={Test1} alt="test" className="" />
                          <p className="rounded-b-lg bg-slate-100 py-3 px-4">
                            some text description
                          </p>
                        </div>
