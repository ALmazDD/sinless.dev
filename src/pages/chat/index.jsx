...
function App() {
  ...
  const handleInput = () => {
    ...
    const words = new RegExp(badwords);
    ...
    const words2 = new RegExp(welcome);
    ...
    const bye = ["bye|Bye|goodbye|see you later|cya|goodnight|goodbye"];
    const words3 = new RegExp(bye);
    ...
    const words4 = new RegExp(thanks);
    ...
    const words7 = new RegExp(response);
    ...
    const words8 = new RegExp(nameAsk);
    ...
    const words10 = new RegExp(owner2);
    if (words10.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText =
          "Treasure is a programmer based on ReactJS and NodeJS";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    ...
    const words11 = new RegExp(ageAsk);
  ...
  return (
    <>
      <MainNavigation />
      <div
        className="m-auto mt-5 w-fit rounded-md border p-3"
        onLoad={checkStatus}
      >
        <div className="m-auto flex w-[90%] items-center justify-center">
          <div className="flex flex-col gap-10">
            <div id="message1" ref={botmessage} />
            <div id="message2" ref={humanMessage} />
            <Input
              type="text"
              id="input"
